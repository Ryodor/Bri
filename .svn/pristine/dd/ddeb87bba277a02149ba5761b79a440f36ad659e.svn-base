...
<div class="cell">
Etat des boucles de securite
</div>
<div class="cell">
Etat du point d\'encordement
</div>
<div class="cell">
Etat des elements de conforts
</div>
<div class="cell">
Etat
</div>
...
<label>
<span class="custom-dropdown custom-dropdown--white">
   <select name="etat2" class="custom-dropdown__select custom-dropdown__select--white" required>
       <option value="RAS">RAS</option>
       <option value="Mineuers">Mineuers</option>
       <option value="Majeurs">Majeurs</option>
       <option value="Definitive">Definitive</option>
...
<label>
<span class="custom-dropdown custom-dropdown--white">
   <select name="etat3" class="custom-dropdown__select custom-dropdown__select--white" required>
       <option value="RAS">RAS</option>
       <option value="Mineuers">Mineuers</option>
       <option value="Majeurs">Majeurs</option>
       <option value="Definitive">Definitive</option>
...
<label>
<span class="custom-dropdown custom-dropdown--white">
   <select name="etat4" class="custom-dropdown__select custom-dropdown__select--white" required>
       <option value="RAS">RAS</option>
       <option value="Mineuers">Mineuers</option>
       <option value="Majeurs">Majeurs</option>
       <option value="Definitive">Definitive</option>
...
<label>
<span class="custom-dropdown custom-dropdown--white">
   <select name="etat5" class="custom-dropdown__select custom-dropdown__select--white" required>
       <option value="RAS">RAS</option>
       <option value="Mineuers">Mineuers</option>
       <option value="Majeurs">Majeurs</option>
       <option value="Definitive">Definitive</option>
